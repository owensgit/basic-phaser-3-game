...
export class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('platform-2-tiles', 'assets/img/platforms/platform-2-tiles.png');
    this.load.image('platform-3-tiles', 'assets/img/platforms/platform-3-tiles.png');
    this.load.image('platform-4-tiles', 'assets/img/platforms/platform-4-tiles.png');
    this.load.image('platform-5-tiles', 'assets/img/platforms/platform-5-tiles.png');
    this.load.image('platform-6-tiles', 'assets/img/platforms/platform-6-tiles.png');
    this.load.image('platform-7-tiles', 'assets/img/platforms/platform-7-tiles.png');
    this.load.image('platform-8-tiles', 'assets/img/platforms/platform-8-tiles.png');
    this.load.image('platform-9-tiles', 'assets/img/platforms/platform-9-tiles.png');
    this.load.image('platform-10-tiles', 'assets/img/platforms/platform-10-tiles.png');
    this.load.image('platform-25-tiles', 'assets/img/platforms/platform-25-tiles.png');
  ...
  create() {
    ...
    this.scoreText = this.add.text(620, 16, 'Coins: 0', { fontSize: '30px', fill: '#FFF' });
    this.timerText = this.add.text(20, 16, `Time: ${this.timeLeft}`, { fontSize: '30px', fill: '#FFF' });

    this.physics.add.collider(this.player, this.platforms);
    this.physics.add.collider(this.coins, this.platforms);

    this.physics.add.overlap(this.player, this.coins, this.collectCoin, null, this);
    this.physics.add.collider(this.player, this.baddies, this.endGame.bind(this), null, this);

    this.gameTimeout = setTimeout(this.endGame.bind(this), (this.timeLeft + 1) * 1000);
